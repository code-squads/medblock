    ...
    return (
        <Container>
            ...
            <NavbarContainer>
                ...
                <Home onClick={() => history.push('/home')}>Home<BlueLine/></Home>
                {
                    auth.loggedIn ?
                ...
                <SubContainer4 ref={ref}>
                    <SubContainer5>
                        ...
                        <ImageAndTextContainer>
                            ...
                            <SpecialityText>Decentralized platform for highest safety</SpecialityText>
                        </ImageAndTextContainer>
                        <ImageAndTextContainer>
                            <Image src={PaperLess}/>
                            <SpecialityText>No need to carry your medical reports everywhere</SpecialityText>
                        </ImageAndTextContainer>
                    </SubContainer5>
                </SubContainer4>
