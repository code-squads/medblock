...
const AnyRecord = () => {
    ...
    return (
        <Container>
            <SubContainer1>
                <AppNameContainer>
                    <img src={basicInfo} alt="About medikeep"/>
                ...
                {openWebcam &&<QrReader
                    style={{width: '50%', marginTop: '40px', border: 'solid black 1px'}}
                    delay={300}
            ...
            <SubContainer2>
                <HeadingConatiner>
                    ...
                    <PageName
                        style={{marginTop:'0px', fontSize:'36px'}}
                    >
                        Address
                        <img style={{width: '35px', marginTop: '-10px'}} src={KeyImage} alt="Key"/>
                    </PageName>
                    
                </HeadingConatiner>
                {openWebcamMobile &&<QrReader
                    style={{width: '60%', marginTop: '40px', border: 'solid black 1px'}}
                    delay={300}
                    onError={onHandlerErrWebcam}
                    onScan={onHandlerResultWebcam}
                />}
                {!openWebcamMobile &&<TextFieldContainer>
                    <TextField
                        label="Address"
                        required
                        fullWidth
                ...
                <ButtonContainer>
                    ...
                    <ScanOrButtonMobile onClick={() => setOpenWebcamMobile(!openWebcamMobile)}>
                ...
                <CreateAccountText>New user? visit nearest center to register yourself</CreateAccountText>
            </SubContainer2>
        </Container>
    )
}
