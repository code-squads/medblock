...
import { Box, TextField, Checkbox, Select, MenuItem, InputLabel, FormControl } from '@mui/material';
...
import { newPatientRegistration, isPatientAlreadyRegistered, sendEth } from "../apis/medblock";
...
import { DashboardIcon, DownloadIcon, NoteSection } from './PatientRegistration.styled';
...
const PatientRegistration = () => {
    ...
    async function registerPatient(event){
        ...
        let isOccupied = await isPatientAlreadyRegistered(newPatientAccount.address);
        if(isOccupied){
            setIsProcessing(false);
            return alert("The generated address is occupied by another patient. Reload & try again");
        }
        ...
        try{
            ...
            console.log("Some error registering new hospital:", newPatientAccount.address);
            console.log(err);
        }
                ...
                <Col md={12} lg={6}>
                    {
                        ...
                        <center>
                            ...
                            <div>
                                ...
                                <br/>
                                <Row>
                                    <Col md={6} style={{paddingLeft: "22px", paddingRight: "22px"}}>
                                        <Row>
